               ...
               <div class="form">
                  <div class="input_msg_write">
                     <textarea 
																								...
																								onblur="this.placeholder = 'Click here to enter Username'"
																								style="margin-right: 30px; height: 100px; width: 410px; padding: 10px; font-size: 25px;"></textarea>
                     <button class="btn btn-primary" type="button" onclick="message()" style=" border: 3px solid white; background-color: #171e75; margin-top: -100px; font-size: 25px;"><strong>Send Message Button</strong></button>
                  </div>
               </div>
            </div>
         </div>
